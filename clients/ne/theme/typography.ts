...
export const nepaliTypography = {
  // Font Families (using Devanagari script fonts)
  fontFamily: {
  ...
  // Font Sizes (Nepali Devanagari script needs good readability)
  fontSize: {
    xs: SIZES.xs,                       // 12
    sm: SIZES.sm,                       // 14
    md: SIZES.md + 1,                   // 17
  ...
  // Letter Spacing (Nepali Devanagari benefits from normal to slightly wider spacing)
  letterSpacing: {
    tight: -0.2,
    normal: 0.3,
    wide: 0.8,
