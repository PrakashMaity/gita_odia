...
export const MalaJapaHeader: React.FC = React.memo(() => {
    ...
    return (
        ...
        >
            <HStack className="items-center justify-between">
                ...
                <Box className="items-center flex-1 mx-3">
                    <Text
                        className="text-[20px] font-black tracking-tight text-center"
                        style={{ fontFamily: fonts.regional_secondary, color: theme.text.primary }}
                        numberOfLines={1}
                    >
                        {i18n.t('malaJapa.title')}
                    </Text>
                    <Text
                        className="text-[12px] font-medium text-center mt-0.5 opacity-60"
                        style={{ fontFamily: fonts.regional_secondary, color: theme.text.primary }}
                        numberOfLines={1}
                    >
                        {i18n.t('malaJapa.subtitle')}
                    </Text>
                </Box>
...
MalaJapaHeader.displayName = 'MalaJapaHeader';
