...
import { styles } from './EmptyBookmarkState.styles';
            ...
            {[
              ...
              <ThemedView key={index} style={styles.tipItem}>
                <ThemedView style={[styles.tipIcon, { backgroundColor: theme.background.quaternary }]}>
                  <Ionicons name="checkmark-circle" size={20} color={theme.icon.primary} />
                </ThemedView>
                <ThemedLanguageText
                  variant="secondary"
                  size="medium"
